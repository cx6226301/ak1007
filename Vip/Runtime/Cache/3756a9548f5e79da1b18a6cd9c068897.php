...
<link href="__PUBLIC__/other/Css/login.css" rel="stylesheet" type="text/css" />
<script type="text/javascript">document.write("<scr"+"ipt src=\"__PUBLIC__/other/Js/Base.js\"></sc"+"ript>")</script>
<script type="text/javascript">document.write("<scr"+"ipt src=\"__PUBLIC__/other/Js/prototype.js\"></sc"+"ript>")</script>
<script type="text/javascript">document.write("<scr"+"ipt src=\"__PUBLIC__/other/Js/mootools.js\"></sc"+"ript>")</script>
<script type="text/javascript">document.write("<scr"+"ipt src=\"__PUBLIC__/other/Js/Ajax/ThinkAjax.js\"></sc"+"ript>")</script>
<script type="text/javascript">document.write("<scr"+"ipt src=\"__PUBLIC__/other/Js/Form/CheckForm.js\"></sc"+"ript>")</script>
<script type="text/javascript">document.write("<scr"+"ipt src=\"__PUBLIC__/other/Js/common.js\"></sc"+"ript>")</script>
<!--[if IE 6]>
			...
			<div id="login_box">
				...
				<table width="100%" cellpadding="0" cellspacing="0" class="ltable">
					...
					<tr>
						...
						<td><input name="verify" id="verify" type="text" onKeyDown="keydown(event)" check="Require" warning="请输入验证码" maxlength="10" onfocus="this.className='ipt_hover ipt_style'" onblur="this.className='ipt_text ipt_style'" maxlength="4" class="ipt_text" style="width:109px" />
							<input type="hidden" name="ajax" value="1">
							<img id="verifyImg" src="__URL__/verify/" width="60" onClick="fleshVerify()" border="0" alt="点击刷新验证码" style="cursor:pointer" align="absmiddle" />
							<a href="#" onclick="fleshVerify()" title="点击刷新验证码"  style=" text-decoration:none; color:#ae271d; padding-left: 5px;">看不清？换一张</a>
						</td>
					</tr>
					<tr>
						<td></td>
...
ThinkAjax.image = [	 '__PUBLIC__/other/Images/loading2.gif', '__PUBLIC__/other/Images/ok.gif','__PUBLIC__/other/Images/update.gif' ]
ThinkAjax.updateTip	=	'登录中～';
function loginHandle(data,status){
if (status==1)
{
$('result').innerHTML	=	'<span style="color:blue"><img SRC="__PUBLIC__/other/Images/ok.gif" WIDTH="20" HEIGHT="20" BORDER="0" ALT="" align="absmiddle" > 登录成功！3 秒后跳转～</span>';
$('form1').reset();
