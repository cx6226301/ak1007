			...
			<div id="login_box">
				...
				<table width="100%" cellpadding="0" cellspacing="0" class="ltable">
					...
					<tr>
						...
						<td><input name="verify" id="verify" type="text" onKeyDown="keydown(event)" check="Require" warning="请输入验证码" onfocus="this.className='ipt_hover ipt_style'" onblur="this.className='ipt_text ipt_style'" maxlength="5" class="ipt_text" style="width:109px" />
