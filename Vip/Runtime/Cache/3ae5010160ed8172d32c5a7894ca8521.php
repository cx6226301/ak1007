...
<div class="accounttitle"><h1>加单功能 </h1></div>

      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tab1">
      <tr>
        <td>
            <form method='post' id="form1" name="form1" action="__URL__/jiadanAdd" onsubmit="return Email('UserEmail');"/>
        <table width="100%" border="0" cellpadding="3" cellspacing="0" class="tab4">
          <tr>
            <td width="20%" align="right"><span class="zc_hong">*</span> 所属报单中心：</td>
            <td width="20%"><input name="shopid" type="text" id="shopid" value="<?php echo ($zzc[1]); ?>" style="background-color: #CCC" readonly class="ipt" onKeyUp="guolv(this.name)" onFocus="notice('0','')" onBlur="javascript:yhServer(this.name,'0');notice('0','none')" /></td>
          ...
          <tr>
            ...
            <td width="20%"><input name="RID" id="RID" type="text" value="<?php echo ($zzc[2]); ?>" class="ipt" style="background-color: #CCC" readonly onKeyUp="guolv(this.name)" onFocus="notice('1','')" onBlur="javascript:yhServer(this.name,'1');notice('1','none')" /></td>
          ...
          <tr>
            ...
            <td>
			<?php if(($myid) != "0"): ?><input name="UserID" id="UserID" type="text"  value="<?php echo ($flist[1]['UserID']); ?>" class="ipt" onKeyUp="guolv(this.name)" onFocus="notice('3','')" onBlur="javascript:yhServer(this.name,'3');notice('3','none')" />
            <?php else: ?>
          ...
          <tr>
            ...
            <td><input name="Password" type="password" class="ipt"  id="Password" onFocus="notice('4','')"  onblur="javascript:yhPass(this.name);notice('4','none');" value="111111"/></td>
          ...
          <tr>
            ...
            <td><input name="rePassword" type="password" class="ipt"  id="rePassword" onFocus="notice('5','')"  onblur="javascript:yhrePass(this.name,'Password');notice('5','none')" value="111111"/></td>
          ...
          <tr>
            ...
            <td><input name="PassOpen" type="password" class="ipt"  id="PassOpen" onFocus="notice('6','')"  onblur="javascript:yhPass(this.name);notice('6','none')" value="222222"/></td>
          ...
          <tr>
            ...
            <td><input name="rePassOpen" type="password" class="ipt"  id="rePassOpen" onFocus="notice('7','')"  onblur="javascript:yhrePass(this.name,'PassOpen');notice('7','none')" value="222222"/></td>
          ...
          <tr style="display:none">
            ...
            <td><input name="BankCard" type="text" class="ipt" id="BankCard" onFocus="notice('8','')"  onblur="notice('8','none')" onKeyUp="javascript:Null_Int(this.name)" value="11122" maxlength="19" /></td>
          ...
          <tr style="display:none">
            ...
            <td><input name="UserName" type="text" class="ipt"  id="UserName" onFocus="notice('9','')"  onblur="notice('9','none')" onKeyUp="javascript:Null_Full(this.name)" value="222" maxlength="10" /></td>
          ...
          <tr style="display:none">
            ...
            <td><input name="BankAddress" type="text" class="ipt" id="BankAddress" value="4554" /></td>
          ...
          <tr>
            ...
            <td><input name="UserCode" type="text" class="ipt" id="UserCode" onFocus="notice('11','')"  onblur="notice('11','none')" onKeyUp="javascript:Null_Full(this.name)" value="888" maxlength="18" /></td>
            <td><div id="UserCode1" class="info"><div id="11" class="focus_r" style="display:none;"><div class="msg_tip">请输入您的身份证号。</div></div></div></td>
          </tr>
          <tr>
            <td align="right">联系地址：</td>
            <td><input name="UserAddress" type="text" class="ipt" id="UserAddress" onFocus="notice('12','')"  onblur="notice('12','none')" onKeyUp="javascript:Null_Full(this.name)" value="888" /></td>
          ...
          <tr>
            ...
            <td><input name="UserEmail" type="text" class="ipt"  id="UserEmail" onblur="Email(this.id)" value="888" /></td>
          ...
          <tr>
            ...
            <td><input name="qq" type="text" class="ipt"  id="qq" onFocus="notice('16','')"  onblur="notice('16','none')" onKeyUp="javascript:Null_Int(this.name)" value="8888" /></td>
          ...
          <tr>
            ...
            <td><input name="UserTel" type="text" class="ipt"  id="UserTel" onFocus="notice('13','')"  onblur="notice('13','none')" onKeyUp="javascript:Null_Full(this.name)" value="138"/></td>
			...
			<tr>
				...
				<strong><span class="STYLE3"><?php echo ($s9[$key]); ?>元</span></strong>
				<?php else: ?>
				<input name="u_level" type="radio" id="radio" value="<?php echo ($key); ?>"/>
			    <strong><span class="STYLE3"><?php echo ($s9[$key]); ?>元</span></strong><?php endif; endforeach; endif; else: echo "" ;endif; ?>
		  ...
		  <tr style="display: none">
            ...
            <table width="90%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#b9c8d0" class="tab3" id="tb1">
          ...
          <tr style="display: none">
            <td colspan="3" >
            <table width="90%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#b9c8d0" class="tab3">
              <tr>
          ...
          <tr>
            ...
            <td><span class="center">
              <input name="submit1" id="Access" type="submit" class="button_text" value="加单" />
  &nbsp;&nbsp;
