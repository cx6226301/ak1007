...
<table class="ccdd" cellspacing=0 cellpadding=0 border=0>
     <tbody>
        ...
        <td align=left>[<span style="color:red"><?php echo (getdengji($fck_rs['user_id'])); ?></span>]<?php if(($qk) == "1"): ?><a style="color:blue" href="javascript:void(0)" onclick="if(confirm('确定激活用户?')) window.location.href='__APP__/Public/jihuo';else return false;">激活</a><?php endif; ?></td></tr>
        <tr>
